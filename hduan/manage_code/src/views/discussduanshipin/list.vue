	...
	<div>
		<div class="center_view">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('discussduanshipin','新增')">
						新增
					</el-button>
			...
			<el-table
                ...
                <el-table-column v-if="btnAuth('discussduanshipin','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
                    <template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('discussduanshipin','修改')">
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)" >
							删除						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('discussduanshipin','查看评论')" type="warning" @click="commentClick(scope.row.id)">
							查看评论
						</el-button>
...
<script setup>
	...
	const tableName = 'discussduanshipin'
	const formName = '短视频评论表'
	...
	const delClick = (id) => {
		...
		ElMessageBox.confirm(`是否删除选中${formName}`, '提示', {
			...
			context.$http({
                ...
                context.$http.get(`duanshipin/info/${route.query.refid}`).then(res=>{
                    let detail = res.data.data
                    detail.discussNumber -= ids.length
                    context.$http.post(`duanshipin/update`,detail)
                })
			})
		}).catch(_ => {})
	}
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscussduanshipin?refid=' + id)
	}

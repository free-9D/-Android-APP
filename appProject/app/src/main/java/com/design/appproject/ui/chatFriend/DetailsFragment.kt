...
import com.design.appproject.logic.viewmodel.chatFriend.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.ChatfriendcommonDetailsLayoutBinding
 ...
 * 好友表详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_CHATFRIEND)
class DetailsFragment : BaseBindingFragment<ChatfriendcommonDetailsLayoutBinding>() {
    ...
    private var mChatFriendItemBean=ChatFriendItemBean()/*详情内容*/
    ...
    private fun loadData(){
        mDetailsViewModel.info("chatfriend",mId.toString())
    }


    private fun ChatfriendcommonDetailsLayoutBinding.setInfo(){
        uidTv.text = "${mChatFriendItemBean.uid}"
        fidTv.text = "${mChatFriendItemBean.fid}"
        nameTv.text = "${mChatFriendItemBean.name}"
        pictureIfv.load(requireActivity(),"${mChatFriendItemBean.picture}")
        roleTv.text = "${mChatFriendItemBean.role}"
        tablenameTv.text = "${mChatFriendItemBean.tablename}"
        aliasTv.text = "${mChatFriendItemBean.alias}"
        typeTv.text = "${mChatFriendItemBean.type}"

...
import com.design.appproject.logic.viewmodel.shangpinfenlei.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.ShangpinfenleicommonDetailsLayoutBinding
 ...
 * 商品分类详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_SHANGPINFENLEI)
class DetailsFragment : BaseBindingFragment<ShangpinfenleicommonDetailsLayoutBinding>() {
    ...
    private var mShangpinfenleiItemBean=ShangpinfenleiItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mShangpinfenleiItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("shangpinfenlei",mId.toString())
    }


    private fun ShangpinfenleicommonDetailsLayoutBinding.setInfo(){
        shangpinfenleiTv.text = "${mShangpinfenleiItemBean.shangpinfenlei}"

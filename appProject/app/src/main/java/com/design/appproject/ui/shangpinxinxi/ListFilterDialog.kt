...
import com.design.appproject.databinding.ShangpinxinxiFilterDialogLayoutBinding
...
class ListFilterDialog(context: Context) : DrawerPopupView(context) {
    ...
    lateinit var binding: ShangpinxinxiFilterDialogLayoutBinding
    ...
    override fun onCreate() {
        ...
        binding.apply {
            ...
            resetBtn.setOnClickListener { //重置
                shangpinpinpaiEt.setText("")
                callBackListener?.invoke(false,null)
            }
            ensureBtn.setOnClickListener { //确定
                params.clear()
                shangpinpinpaiEt.text.toString().isNotNullOrEmpty().yes {
                    val filterContent = shangpinpinpaiEt.text.toString()
                    params.put("shangpinpinpai","%${filterContent}%")
                }

...
import com.design.appproject.logic.viewmodel.fankuiyijian.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.FankuiyijiancommonDetailsLayoutBinding
 ...
 * 反馈意见详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_FANKUIYIJIAN)
class DetailsFragment : BaseBindingFragment<FankuiyijiancommonDetailsLayoutBinding>() {
    ...
    private var mFankuiyijianItemBean=FankuiyijianItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mFankuiyijianItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("fankuiyijian",mId.toString())
    }


    private fun FankuiyijiancommonDetailsLayoutBinding.setInfo(){
        fankuibiaotiTv.text = "${mFankuiyijianItemBean.fankuibiaoti}"
        fankuineirongCw.setHtml(mFankuiyijianItemBean.fankuineirong.trim())
        fankuishijianTv.text = "${mFankuiyijianItemBean.fankuishijian}"
        shangjiazhanghaoTv.text = "${mFankuiyijianItemBean.shangjiazhanghao}"
        shangjiaxingmingTv.text = "${mFankuiyijianItemBean.shangjiaxingming}"

...
import com.design.appproject.logic.viewmodel.chatMessage.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.ChatmessagecommonDetailsLayoutBinding
 ...
 * 消息表详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_CHATMESSAGE)
class DetailsFragment : BaseBindingFragment<ChatmessagecommonDetailsLayoutBinding>() {
    ...
    private var mChatMessageItemBean=ChatMessageItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mChatMessageItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("chatmessage",mId.toString())
    }


    private fun ChatmessagecommonDetailsLayoutBinding.setInfo(){
        uidTv.text = "${mChatMessageItemBean.uid}"
        fidTv.text = "${mChatMessageItemBean.fid}"
        contentTv.text = "${mChatMessageItemBean.content}"
        formatTv.text = "${mChatMessageItemBean.format}"
        isReadTv.text = "${mChatMessageItemBean.isRead}"

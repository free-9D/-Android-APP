...
import com.design.appproject.logic.viewmodel.yijianfankui.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.YijianfankuicommonDetailsLayoutBinding
 ...
 * 意见反馈详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_YIJIANFANKUI)
class DetailsFragment : BaseBindingFragment<YijianfankuicommonDetailsLayoutBinding>() {
    ...
    private var mYijianfankuiItemBean=YijianfankuiItemBean()/*详情内容*/
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mYijianfankuiItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("yijianfankui",mId.toString())
    }


    private fun YijianfankuicommonDetailsLayoutBinding.setInfo(){
        fankuibiaotiTv.text = "${mYijianfankuiItemBean.fankuibiaoti}"
        fankuineirongCw.setHtml(mYijianfankuiItemBean.fankuineirong.trim())
        fankuishijianTv.text = "${mYijianfankuiItemBean.fankuishijian}"
        yonghuzhanghaoTv.text = "${mYijianfankuiItemBean.yonghuzhanghao}"
        yonghuxingmingTv.text = "${mYijianfankuiItemBean.yonghuxingming}"
